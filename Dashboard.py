...
with col1:
    ...
    weather_trend["weathersit"] = weather_trend["weathersit"].map(weather_labels.get)
...
with col2:
    ...
    seasonal_trend["season"] = seasonal_trend["season"].map(season_labels.get)
